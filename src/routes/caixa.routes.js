...
routes.get('/filtro', login.obrigatorioLogin, caixaController.readCaixas); // passar o campo obs_identificador para filtrar por observação ou identificador_balanca
routes.get('/:caixa_id', login.obrigatorioLogin, caixaController.readOneCaixaId); // passar caixa_id
